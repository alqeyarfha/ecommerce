...
// ================================================
Auth::routes();
Route::get('/cart', 'CartController@index');          // ← old string syntax (Laravel 8 and below)
// or
Route::get('/something', [CartController::class, 'method']);
// but the class is missing or in the wrong namespace
// ================================================================
// FILE: routes/web.php
// ================================================================
//
